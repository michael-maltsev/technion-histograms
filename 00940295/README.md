# 00940295 - מעבדה בניתוח והצגת נתונים
...
| ---- | ---- |
| כהן סתיו |  |
| גנוסר בר | מדריך מעבדה - עם הרשאות מרצה אחראי |
